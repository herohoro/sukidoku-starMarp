...
## 2025-01-01 ~ 01-31
- hellotalkでチャットをしながらやる気をためた
	- 年末年始に勉強ストップしてからなかなかやる気になれずに困ってたところにユグさんからの誘いがあった
	- タイムラインで流れてくるハングルを読んで楽しむうちに読めるようになりたくなった
	- 実際に韓国の人とチャットしてると余計に気持ちを伝えられるようになりたくなった
- 「韓国語の教科書」をはじめから文法に注目してやり直すことにした
	- 本文を読んでそこで習う文法を確認する
	- 覚えにくいのは演習問題をやって整理する
	- ノートに演習問題を書き写してハングルを書くことに慣れる
	- 動詞の活用がまだ分からないから、基本形をノートの端にメモしておく
	- パターン化は自分で書き直して小さなリングノートに書いておく。それをいつも見て覚えるようにする
	- もともと書くことが楽しいから楽しみながら進められてる
	- 書いたノートを見て復習できる状態にできている
- 「韓韓韓単語」という単語帳兼辞書を買っていつでも単語を調べられる状態にした
	- 単語だけ覚えようと数日やってみたけど、やっぱ続かなかった
	- 分からない単語を調べるときに役立つ事が多い

## 2024-12-01 ~ 12-31
- 「韓国語の教科書」を引き続き週２でやった
	1. 音声流したまま昼食
	2. 食べ終わったら本文と欄外の単語を見て意味を推測する
	3. 推測した意味が合ってるかを確認する
	4. 正しい意味と文法を整理する
	5. 音声と同じスピードで言えるまで練習する
	6. 普段の日記を書く時に習ったことをまとめようと努力してみる

## 2024-11-01 ~ 11-30
- スケッチの描き方を分かりやすく解説してくれるYouTubeチャンネル(KEEZOO sketch)のショート動画を文字起こしして、Notion上で調整した後、印刷して読解教材を作ってみた
	- 何度も再生しながら、ハングルに読み方をメモしてみた
	- 文字起こしの精度があまりよくない部分もあった
	- ショート動画はもともと倍速された音声をアップしてるっぽくって、ゆっくり聞こうとして低倍速にするとお化けみたいな音声になって聞きにくかった
	- 【収穫】指示語をたくさん学べた
	- 【次回に向けて】文字数的にはショート動画がちょうど良さそうだと思ってやってみたけど、普通の動画の方がゆっくり話した音声で分かりやすい。
- Migakuにできた韓国語レッスンを読んで勉強した
	- 本文は英語だから、英語の勉強にもなった
- 「韓国語の教科書」を引き続き週２でやった
	- Unit8-1~10-1
## 2024-10-01 ~ 10-31
